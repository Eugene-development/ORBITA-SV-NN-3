		...
		<div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
					...
					<div class="md:grid md:grid-cols-1">
						<div>
							...
							<div class="mt-4 space-y-3">
								...
								<!--								</p>-->
								<!--								<a-->
								<!--									class="flex text-base text-gray-100 hover:text-white"-->
				...
				<div class="mt-8 xl:mt-0">
					...
					<form class="mt-4 sm:flex sm:max-w-md">
						...
						<div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
							<button
								type="submit"
								class="flex w-full items-center justify-center rounded-md border border-transparent bg-red-900 py-2 px-4 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-700 focus:ring-offset-2 focus:ring-offset-red-800"
							>
								Подписаться
							</button>
						</div>
			...
			<div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
				...
				<p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
					&copy; 2015-{year} База строительных материалов "Орбита-строй". <br />
