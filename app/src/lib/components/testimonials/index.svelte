		...
		<div class="py-12 px-12 md:flex md:flex-col md:border-r md:border-indigo-900 md:py-16 ">
			...
			<blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
				<div class="relative text-lg font-medium text-white md:flex-grow">
					...
					<br />
					<p class="relative">
						От имени АО "Ремстроймонтаж", я хочу выразить нашу благодарность коллективу
						"Орбита-Строй" за их безупречную профессиональность и эффективность в обеспечении
						качественных строительных материалов. Глубокий уровень экспертизы вашей команды вносит
						значительный вклад в решение широкого спектра задач, связанных с поставками строительных
						материалов для наших проектов.
					</p>
				</div>
				<footer class="mt-8">
					<div class="flex">
		...
		<div class="border-t-2 py-12 px-12 md:border-t-0 md:border-l md:py-16 ">
			...
			<blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
				<div class="relative text-lg font-medium text-white md:flex-grow">
					...
					<br />
					<p class="relative">
						В качестве генерального директора ООО "ПСГ" Химрегион, я хочу выразить нашу искреннюю
						признательность "Орбита-Строй". С 2016 года мы имеем удовольствие работать с Вами,
						оценивая ваше преданное обслуживание клиентов и высокий уровень профессионализма. Мы
						приветствуем широкий выбор предлагаемых продуктов, регулярные акции и доступные цены. С
						нетерпением ждем продолжения нашего плодотворного сотрудничества с вами и вашей
						командой.
					</p>
				</div>
				<footer class="mt-8">
